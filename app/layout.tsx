...
export const metadata: Metadata = {
  ...
  It includes animations and transitions for an engaging interface. The design is optimized for performance and accessibility, ensuring a seamless experience across devices. The use of modern web technologies enhances the visual appeal and functionality of the landing page.",
};
